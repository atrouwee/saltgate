...
| `silbersalz-500t_v1-paired_33.cube` | 2026-08-23 | **Vision3 500T**, APOLLON era | 5 real flat/graded pairs from one donor, one roll (thanks Faraz), 16-bit files on both sides | Held out one frame at a time: median ΔE2000 **1.7** (p90 6.4 — one frame where the lab lifted black by hand). Black point within 0.1 L\* of the lab. **Beta** — a second roll is what makes it *validated* |
