...
| `silbersalz-gold200_v1-paired_33.cube` | 2026-08-23 | **Kodak Gold 200 (C-41)**, APOLLON 14K era | **27 real flat/graded pairs** (donor: Cody, rolls 057 + 067), Stage C (shared LUT + per-shot gains) | **5-fold held-out median ΔE2000 1.79, p90 2.23.** Per-shot gains tiny and roll-consistent (≈ −0.08 / +0.08 stop, R=G=B within 1%) → the lab applied one base look + per-roll density, no per-frame white balance. |
