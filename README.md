...
| 125T Special ("Edition Vivid") | borrows `silbersalz-500t_v1-paired_33.cube` | **Beta (500T)** — no 125T pairs | tungsten-balanced ([source](https://phillipreeve.net/blog/analogue-adventures-part-36-silbersalz35-125t-edition-vivid/)), reportedly a Fuji Eterna Vivid stock rather than Vision3 — so the 500T LUT is the nearest family we have, with a larger expected deviation. (Gold ↔ Vision3 does *not* transfer — different curves) |
